  ...
  return (
    <div className='bg-primary/60 h-full'>
      ...
      <div className='w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10'>
        <div className='text-center flex flex-col justify-center xl:text-left  mx-auto container'style={{paddingTop:'10rem'}} >
          {/* Title */}
          <motion.h1
            ...
            animate='show'
            exit='hidden'
            className='h1' // Increase text size for small screens
          >
          ...
          <motion.p 
            ...
            animate="show" 
            exit="hidden"
            className='max-w-sm xl:max mx-auto xl:mx-0 mb-10 xl:mb-16'
          >
      ...
      <div className= 'w-full h-full absolute right-0 bottom-0'> {/* Adjust image height for small screens */}
        ...
        <div className='hidden xl:flex  absolute bottom-0 right-2'>
          <motion.div  
            ...
            className='sm:hidden w-full h-full max-w-[737px] max-h-[678px] absolute -bottom-32 lg:bottom-0 lg:right-[8%]' // Adjust size and positioning for small screens
          >
          </motion.div>
          <Avatar />
        </div>
